...
<Script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3195590881637489"
  ...
  gtag('config', 'G-33Z53GSFZ2');`}
      ...
      keywords={	["Tejas Chaudhari","Tejas Sanjay Chaudhari","Tejas Developer","Tejas Nandurbar","Nandurbar","Dhule","Tejas Codes", "software developer", "web developer","website", "blog", "portfolio","tejas networks share price","tejas express","tejas thackeray","hal tejas","tejas aircraft","tejas meaning in hindi","tejas express mumbai to delhi"]}

...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  gtag('config', 'G-33Z53GSFZ2');`}
     ...
     keywords={	["Tejas Chaudhari","Tejas Sanjay Chaudhari","Tejas Developer","Tejas Nandurbar","Nandurbar","Dhule","Tejas Codes", "software developer", "web developer","website", "blog", "portfolio"]}
